...
public enum Lang implements Cons {
	...
	PLUGIN_OWN_REGION_OVERLAPPING ("&aOwnRegionOverlapping&e: &6" + VALUE),
	PLUGIN_FLAGS		("&aFlags"),
	...
	PLUGIN_HOVER_OWN_REGION_OVERLAPPING("&aChange if the own regions of a player are allowed to overlap"),
